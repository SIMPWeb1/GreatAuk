...
function Kf(e, t, n) {
  ...
  if (t != null)
    ...
    t))
      Xf.call(t, r) && !Qf.hasOwnProperty(r) && (i[r] = t[r]);
...
function Ii(e, t, n, r, i) {
  ...
  if (((o = 0), (r = r === "" ? "." : r + ":"), gu(e)))
    ...
    for (e = a.call(e), l = 0; !(s = e.next()).done; )
      (s = s.value), (a = r + ro(s, l++)), (o += Ii(s, t, n, a, i));
  else if (s === "object")
    throw (
      ((t = String(e)),
      Error(
      ...
      return (
        ...
        O > M
          ? ((_.sortIndex = O),
            ...
            n(a) === null &&
              _ === n(u) &&
              (x ? (p(P), (P = -1)) : (x = !0), et(w, O - M)))
          : ((_.sortIndex = $), t(a, _), v || g || ((v = !0), Fe(S))),
        _
      );
    }),
...
function Go(e, t) {
  ...
  t.hasOwnProperty("value")
    ? bo(e, t.type, n)
    : t.hasOwnProperty("defaultValue") && bo(e, t.type, Ht(t.defaultValue)),
    t.checked == null &&
...
function hd() {
  if (Wn) {
    var e = Wn,
      t = Hn;
    if (((Hn = Wn = null), Eu(e), t)) for (e = 0; e < t.length; e++) Eu(t[e]);
  }
}
function pd(e, t) {
  return e(t);
...
function Tg(e, t, n, r, i) {
  switch (t) {
    ...
    case "gotpointercapture":
      return (
        (s = i.pointerId), $r.set(s, ur($r.get(s) || null, e, t, n, r, i)), !0
      );
  }
  return !1;
}
...
function cr(e, t) {
  e.blockedOn === t &&
    ...
    ol ||
      ((ol = !0),
      De.unstable_scheduleCallback(De.unstable_NormalPriority, _g)));
}
function Wr(e) {
  function t(i) {
    return cr(i, e);
...
var sr = {
  ...
  Ds = Z({}, li, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== fr &&
            (fr && e.type === "mousemove"
              ? ((uo = e.screenX - fr.screenX), (co = e.screenY - fr.screenY))
              : (co = uo = 0),
            (fr = e)),
          uo);
    },
  ...
  Au = Ie(Ds),
  Ag = Z({}, Ds, { dataTransfer: 0 }),
  Vg = Ie(Ag),
  Mg = Z({}, li, { relatedTarget: 0 }),
  fo = Ie(Mg),
  Dg = Z({}, sr, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Og = Ie(Dg),
  Rg = Z({}, sr, {
...
var Wg = Z({}, li, {
  ...
  Qg = Ie(Xg),
  Kg = Z({}, sr, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Gg = Ie(Kg),
  bg = Z({}, Ds, {
    deltaX: function (e) {
...
function tv(e, t) {
  if (jn)
    return e === "compositionend" || (!ga && Md(e, t))
      ? ((e = Ad()), (Bi = ha = Lt = null), (jn = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function sv(e, t, n) {
  e === "focusin"
    ? (Fu(), (Tr = t), (Hr = n), Tr.attachEvent("onpropertychange", Id))
    : e === "focusout" && Fu();
}
function ov(e) {
...
function Rs(e) {
  ...
  var t = Ln[e],
    n;
  for (n in t) if (t.hasOwnProperty(n) && n in Bd) return (mo[e] = t[n]);
  return e;
}
        ...
        for (var h = u, m; h !== null; ) {
          ...
          if (
            (m.tag === 5 &&
              w !== null &&
              ((m = w),
              p !== null && ((w = Br(h, p)), w != null && x.push(Qr(h, w, m)))),
            E)
          )
            break;
          h = h.return;
      ...
      P &&
        (Vd &&
          ...
          (jn || P !== "onCompositionStart"
            ? P === "onCompositionEnd" && jn && (k = Ad())
            : ((Lt = c),
              (ha = "value" in Lt ? Lt.value : Lt.textContent),
              (jn = !0))),
        (T = ss(u, P)),
        0 < T.length &&
          ((P = new Vu(P, e, null, n, c)),
...
function Hu(e, t, n, r, i) {
  for (var s = t._reactName, o = []; n !== null && n !== r; ) {
    ...
    l.tag === 5 &&
      ...
      ((l = u),
      i
        ? ((a = Br(n, s)), a != null && o.unshift(Qr(n, a, l)))
        : i || ((a = Br(n, s)), a != null && o.push(Qr(n, a, l)))),
      (n = n.return);
  }
...
function Kd(e, t, n) {
  ...
  if (((t = t.childContextTypes), typeof r.getChildContext != "function"))
    return n;
  r = r.getChildContext();
  for (var i in r) if (!(i in t)) throw Error(C(108, sg(e) || "Unknown", i));
  return Z({}, n, r);
}
function as(e) {
  return (
...
function xa(e) {
  for (; e === us; )
    (us = Mn[--Dn]), (Mn[Dn] = null), (cs = Mn[--Dn]), (Mn[Dn] = null);
  for (; e === mn; )
    (mn = Be[--Ue]),
      (Be[Ue] = null),
      (dt = Be[--Ue]),
      ...
      return (
        (t =
          t.nodeType !== 1 || n.toLowerCase() !== t.nodeName.toLowerCase()
            ...
            : t),
        t !== null
          ? ((e.stateNode = t), (Me = e), (Ae = Ot(t.firstChild)), !0)
          : !1
      );
    case 6:
      return (
...
function He(e) {
  ...
  if (Sa !== e)
    if (((e = { context: e, memoizedValue: t, next: null }), On === null)) {
      ...
      (On = e), (ds.dependencies = { lanes: 0, firstContext: e });
    } else On = On.next = e;
  return t;
}
var an = null;
...
function nh(e, t, n) {
  ...
  return (
    typeof s == "object" && s !== null
      ? (s = He(s))
      : ((i = Te(t) ? pn : ve.current),
        (r = t.contextTypes),
        (s = (r = r != null) ? bn(e, i) : Yt)),
    (t = new t(n, s)),
...
function wl(e, t, n, r) {
  ...
  typeof s == "object" && s !== null
    ? (i.context = He(s))
    : ((s = Te(t) ? pn : ve.current), (i.context = bn(e, s))),
...
function rh(e) {
      ...
      : h !== null &&
        (h.elementType === S ||
          (typeof S == "object" &&
            ...
            S.$$typeof === Et &&
            nc(S) === h.type))
      ? ((w = i(h, m.props)), (w.ref = dr(p, h, m)), (w.return = p), w)
      : ((w = Ki(m.type, m.key, m.props, null, p.mode, w)),
        (w.ref = dr(p, h, m)),
        (w.return = p),
        w);
  }
  function u(p, h, m, w) {
    return h === null ||
      ...
      ? ((h = No(m, p.mode, w)), (h.return = p), h)
      : ((h = i(h, m.children || [])), (h.return = p), h);
  }
  function c(p, h, m, w, S) {
    return h === null || h.tag !== 7
      ? ((h = hn(m, p.mode, w, S)), (h.return = p), h)
      : ((h = i(h, m)), (h.return = p), h);
  }
  function f(p, h, m) {
    ...
    if (typeof h == "object" && h !== null) {
      switch (h.$$typeof) {
        case gi:
          return (
            (m = Ki(h.type, h.key, h.props, null, p.mode, m)),
            (m.ref = dr(p, null, h)),
            (m.return = p),
            m
          );
      ...
      if (yr(h) || lr(h))
        return (h = hn(h, p.mode, m, null)), (h.return = p), h;
      _i(p, h);
    }
    return null;
  }
  ...
  function v(p, h, m, w) {
    for (
      var S = null, T = null, k = h, P = (h = 0), L = null;
      k !== null && P < m.length;
      P++
    ) {
    ...
    if (k === null) {
      for (; P < m.length; P++)
        (k = f(p, m[P], w)),
          k !== null &&
            ((h = s(k, h, P)), T === null ? (S = k) : (T.sibling = k), (T = k));
      return W && nn(p, P), S;
    }
    for (k = r(p, k); P < m.length; P++)
      (L = g(k, p, P, m[P], w)),
        L !== null &&
  ...
  function x(p, h, m, w) {
    ...
    for (
      var T = (S = null), k = h, P = (h = 0), L = null, A = m.next();
      k !== null && !A.done;
      P++, A = m.next()
    ) {
      k.index > P ? ((L = k), (k = null)) : (L = k.sibling);
    ...
    if (k === null) {
      for (; !A.done; P++, A = m.next())
        (A = f(p, A.value, w)),
          A !== null &&
            ((h = s(A, h, P)), T === null ? (S = A) : (T.sibling = A), (T = A));
      return W && nn(p, P), S;
    }
    for (k = r(p, k); !A.done; P++, A = m.next())
      (A = g(k, p, P, A.value, w)),
        A !== null &&
      ...
      switch (m.$$typeof) {
        case gi:
          e: {
            ...
            m.type === _n
              ? ((h = hn(m.props.children, p.mode, w, m.key)),
                (h.return = p),
                (p = h))
              : ((w = Ki(m.type, m.key, m.props, null, p.mode, w)),
                (w.ref = dr(p, h, m)),
        ...
        case Tn:
          e: {
            ...
            (h = No(m, p.mode, w)), (h.return = p), (p = h);
          }
          return o(p);
        case Et:
    ...
    return (typeof m == "string" && m !== "") || typeof m == "number"
      ? ((m = "" + m),
        h !== null && h.tag === 6
          ...
          : (n(p, h), (h = jo(m, p.mode, w)), (h.return = p), (p = h)),
        o(p))
      : n(p, h);
  }
  return E;
...
function La(e, t, n, r, i, s) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (Wi.current = e === null || e.memoizedState === null ? jv : Nv),
    (e = n(r, i)),
    jr)
  ) {
    s = 0;
...
function ko(e) {
  ...
  if (((e = n.interleaved), e !== null)) {
    i = e;
    do (s = i.lane), (b.lanes |= s), (vn |= s), (i = i.next);
    while (i !== e);
...
function lh(e, t) {
  ...
  if (
    ...
    (r = r.queue),
    Va(ch.bind(null, n, r, e), [e]),
    r.getSnapshot !== t || s || (le !== null && le.memoizedState.tag & 1))
  ) {
    if (
      ((n.flags |= 2048),
      qr(9, uh.bind(null, n, r, i, t), void 0, null),
      ae === null)
    )
      throw Error(C(349));
    gn & 30 || ah(n, t, i);
...
function vh(e, t, n) {
  return (
    (n = n != null ? n.concat([e]) : null), Bs(4, 4, gh.bind(null, t, e), n)
  );
}
function Ma() {}
function yh(e, t) {
...
function wh(e, t, n) {
  return gn & 21
    ? (Je(n, t) || ((n = Cd()), (b.lanes |= n), (vn |= n), (e.baseState = !0)),
      t)
...
function _v(e, t, n) {
  ...
  if (Ph(e)) Ch(t, i);
    ...
    (n = qd(e, t, i, r)),
      n !== null && ((i = we()), Ze(n, e, r, i), kh(n, t, r));
  }
}
function Ph(e) {
  var t = e.alternate;
...
var gs = {
  ...
  jv = {
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        (i.queue = s),
        ic(ch.bind(null, r, s, e), [e]),
        (r.flags |= 2048),
        qr(9, uh.bind(null, r, s, n, t), void 0, null),
        n
      );
    },
    useId: function () {
  ...
  return (
    ...
    e !== null && !ke
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~i),
        wt(e, t, i))
      : (W && n && ya(t), (t.flags |= 1), xe(e, t, r, i), t.child)
  );
}
  ...
  return (
    ...
    e !== null && !ke
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~i),
        wt(e, t, i))
      : (W && r && ya(t), (t.flags |= 1), xe(e, t, n, i), t.child)
  );
}
function cc(e, t, n, r, i) {
  ...
  if ((Xn(t, i), t.stateNode === null))
    Yi(e, t), nh(t, n, r), wl(t, n, r, i), (r = !0);
  else if (e === null) {
    var o = t.stateNode,
      l = t.memoizedProps;
    o.props = l;
...
function Ah(e, t, n) {
  ...
  if (s) {
    ...
    return (
      ...
      l !== null ? (s = zt(l, s)) : ((s = hn(s, o, n, null)), (s.flags |= 2)),
      (s.return = t),
      (r.return = t),
      (r.sibling = s),
      (t.child = r),
...
function Mv(e, t, n, r, i, s, o) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = To(Error(C(422)))), ji(e, t, o, r))
      : t.memoizedState !== null
  ...
  if (((l = (o & e.childLanes) !== 0), ke || l)) {
    if (((r = ae), r !== null)) {
      ...
      (i = i & (r.suspendedLanes | o) ? 0 : i),
        i !== 0 &&
          i !== s.retryLane &&
          ((s.retryLane = i), xt(e, i), Ze(r, e, i, -1));
    }
        ...
        (e === null || e.child === null) &&
          (Ti(t)
            ...
            : e === null ||
              ...
              ((t.flags |= 1024), Ge !== null && (Dl(Ge), (Ge = null)))),
        Tl(e, t),
        me(t),
        null
      );
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || Q.current & 1 ? oe === 0 && (oe = 3) : Ba())),
          t.updateQueue !== null && (t.flags |= 4),
          me(t),
          null);
    case 4:
      return (
        qn(), Tl(e, t), e === null && Xr(t.stateNode.containerInfo), me(t), null
      );
    case 10:
...
function Fv(e, t) {
  ...
  for (fl = { focusedElem: e, selectionRange: n }, rs = !1, j = t; j !== null; )
...
function Rh(e) {
  ...
  t !== null && ((e.alternate = null), Rh(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[st], delete t[Kr], delete t[pl], delete t[wv], delete t[Sv])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
  ...
  switch (e.tag) {
    ...
    case 5:
      ...
      if (r & 4 && ((i = e.stateNode), i != null)) {
        ...
        if (((e.updateQueue = null), a !== null))
          try {
            l === "input" && s.type === "radio" && s.name != null && od(i, s),
              el(l, o);
            var u = el(l, s);
    ...
    case 22:
      if (
        ...
        e.mode & 1 ? ((ge = (u = ge) || c), Xe(t, e), (ge = u)) : Xe(t, e),
        nt(e),
        r & 8192)
      ) {
        if (
...
function Bh(e, t, n) {
  for (var r = (e.mode & 1) !== 0; j !== null; ) {
    ...
    if (i.tag === 22 && r) {
      ...
      i.subtreeFlags & 8772 && s !== null ? ((s.return = i), (j = s)) : gc(e);
  }
}
function gc(e) {
  for (; j !== null; ) {
...
function Ze(e, t, n, r) {
  ...
  oi(e, n, r),
    (!(I & 2) || e !== ae) &&
      (e === ae && (!(I & 2) && ($s |= n), oe === 4 && Nt(e, ce)),
      _e(e, r),
      n === 1 && I === 0 && !(t.mode & 1) && ((tr = te() + 500), Fs && bt()));
}
function _e(e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && _u(n), t === 1))
      e.tag === 0 ? Pv(xc.bind(null, e)) : Gd(xc.bind(null, e)),
        yv(function () {
          !(I & 6) && bt();
        }),
        (n = null);
...
function Uh(e, t) {
  ...
  if (t !== 0) {
    if (
      ...
      throw ((n = ei), dn(e, 0), Nt(e, r), _e(e, te()), n);
    if (t === 6) Nt(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = i), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            (Nt(e, r), (r & 130023424) === r && ((t = Ia + 500 - te()), 10 < t))
          ) {
            if (ns(e, 0) !== 0) break;
...
function Ba() {
  (oe === 0 || oe === 3 || oe === 2) && (oe = 4),
    ae === null || (!(vn & 268435455) && !($s & 268435455)) || Nt(ae, ce);
}
function ws(e, t) {
  var n = I;
  I |= 2;
...
function Qn() {
  if (At !== null) {
    var e = kd(xs),
      ...
      n = F;
    try {
      if (((We.transition = null), (F = 16 > e ? 16 : e), At === null))
        var r = !1;
      else {
        ...
        if (
          ((I = i), bt(), ot && typeof ot.onPostCommitFiberRoot == "function")
        )
          try {
...
function Yv(e, t, n) {
  ...
  r !== null && r.delete(t),
    ...
    ae === e &&
      (ce & n) === n &&
      (oe === 4 || (oe === 3 && (ce & 130023424) === ce && 500 > te() - Ia)
        ? dn(e, 0)
        : (Ra |= n)),
    _e(e, t);
}
...
Qh = function (e, t, n) {
  ...
  switch (((t.lanes = 0), t.tag)) {
      ...
      return (
        ...
        i.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            wl(t, r, e, n),
            (t = Cl(null, t, r, !0, s, n)))
          : ((t.tag = 0), W && s && ya(t), xe(null, t, i, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
    ...
    case 3:
      e: {
        if ((Lh(t), e === null)) throw Error(C(387));
        (r = t.pendingProps),
          (s = t.memoizedState),
          (i = s.element),
          eh(e, t),
...
function Ki(e, t, n, r, i, s) {
  ...
  if (((r = e), typeof e == "function")) Ua(e) && (o = 1);
    ...
    e: switch (e) {
      ...
      case Ho:
        return (
          (e = $e(12, n, t, i | 2)), (e.elementType = Ho), (e.lanes = s), e
        );
      case Yo:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (ca(t, n | 1), _e(t, te()), !(I & 6) && ((tr = te() + 500), bt()));
      }
      break;
    case 13:
      yn(function () {
...
pd = Fa;
md = yn;
var ey = { usingClientEntryPoint: !1, Events: [ai, An, Is, dd, hd, Fa] },
  pr = {
...
const ry = [
  ...
  iy = () => {
    ...
    return y.jsx(y.Fragment, {
      children: y.jsxs("nav", {
        className: `p-4 pr-8 flex justify-between items-center max-w-screen-xl mx-auto rounded-full transition-all ease-in-out duration-300 ${
          e
            ? "bg-white/50 backdrop-blur-lg m-4 mx-4 lg:mx-auto border-solid border-[1px] border-white/80"
            : "bg-transparent m-0 border-solid border-[1px] border-transparent"
        }`,
        children: [
          y.jsx("div", {
            className: "h-16 w-16",
            ...
            children: ry.map((s, o) =>
              y.jsx(
                "a",
                {
                  ...
                  children: y.jsx("p", {
                    className:
                      "font-caprasimo text-drkblu hover:text-white hover:-translate-y-[2px] hover:drop-shadow-sm transition-all ease-in-out duration-300",
                    children: s.name,
                  }),
                },
                o
  ...
  ep = N.createContext({ strict: !1 });
function sy(e, t, n, r) {
  const { visualElement: i } = N.useContext(Ks),
    s = N.useContext(ep),
    o = N.useContext(Xa),
    l = N.useContext(qh).reducedMotion,
    a = N.useRef();
  (r = r || s.renderer),
    !a.current &&
      r &&
...
function ay(e) {
  const { initial: t, animate: n } = ly(e, N.useContext(Ks));
  return N.useMemo(() => ({ initial: t, animate: n }), [Ec(t), Ec(n)]);
}
function Ec(e) {
...
const Tc = {
  ...
  ni = {};
for (const e in Tc) ni[e] = { isEnabled: (t) => Tc[e].some((n) => !!t[n]) };
function uy(e) {
...
function fy({
  ...
  function s(l, a) {
    let u;
    const c = { ...N.useContext(qh), ...l, layoutId: dy(l) },
      { isStatic: f } = c,
      d = ay(l),
      g = r(l, f);
    if (!f && Gs) {
    ...
    return N.createElement(
      ...
      { value: d },
      u && d.visualElement
        ? N.createElement(u, { visualElement: d.visualElement, ...c })
        : null,
      n(i, l, oy(g, d.visualElement, a), g, f, d.visualElement)
    );
  }
...
const ci = [
  ...
  Sn = new Set(ci);
function ip(e, { layout: t, layoutId: n }) {
  return (
    Sn.has(e) ||
    e.startsWith("origin") ||
...
function ba(e, t, n, r) {
  ...
  if (
    (t.transform ||
      (a || r
        ? (i.transform = yy(e.transform, n, c, r))
...
const Ay = { offset: "stroke-dashoffset", array: "stroke-dasharray" },
  Vy = { offset: "strokeDashoffset", array: "strokeDasharray" };
...
function Dy(e, t, n, r) {
  const i = N.useMemo(() => {
    const s = fp();
    return (
      Ja(s, t, { enableHardwareAcceleration: !1 }, qa(r), e.transformTemplate),
      { ...s.attrs, style: { ...s.style } }
    );
  }, [t]);
  if (e.style) {
    const s = {};
    up(s, e.style, e), (i.style = { ...s, ...i.style });
  }
  return i;
}
function Oy(e = !1) {
  return (n, r, i, { latestValues: s }, o) => {
    const a = (Ga(n) ? Dy : Ty)(r, s, o, n),
      c = { ...Ny(r, typeof n == "string", e), ...a, ref: i },
      { children: f } = r,
...
function dp(e, { style: t, vars: n }, r, i) {
...
function tu(e, t) {
  const { style: n } = e,
    r = {};
  for (const i in n)
    (je(n[i]) || (t.style && je(t.style[i])) || ip(i, e)) && (r[i] = n[i]);
  return r;
}
function mp(e, t) {
  const n = tu(e, t);
...
function zy(
  ...
  const o = { latestValues: By(r, i, s, e), renderState: t() };
  ...
  return (
    f &&
      ...
      (Array.isArray(f) ? f : [f]).forEach((g) => {
        const v = nu(e, g);
        if (!v) return;
        const { transitionEnd: x, transition: E, ...p } = v;
        for (const h in p) {
          let m = p[h];
          if (Array.isArray(m)) {
...
function Wy(e, { forwardMotionProps: t = !1 }, n, r) {
  return {
    ...(Ga(e) ? Uy : $y),
    preloadedFeatures: n,
    useRender: Oy(t),
...
const X = { delta: 0, timestamp: 0, isProcessing: !1 },
  Qy = 40;
let Rl = !0,
  ri = !1;
const eo = ["read", "update", "preRender", "render", "postRender"],
  ...
  Sp = (e) => {
    (ri = !1),
      (X.delta = Rl ? 1e3 / 60 : Math.max(Math.min(e - X.timestamp, Qy), 1)),
      (X.timestamp = e),
      (X.isProcessing = !0),
      eo.forEach(Ky),
      (X.isProcessing = !1),
      ri && ((Rl = !1), requestAnimationFrame(Sp));
  },
  Gy = () => {
      ...
      (this.startAccessiblePress = () => {
        const t = (s) => {
            ...
            this.removeEndListeners(),
              (this.removeEndListeners = ht(this.node.current, "keyup", o)),
              Lo("down", (l, a) => {
                this.startPress(l, a);
              });
          },
...
function t0({ root: e, ...t }) {
  const n = e || document;
  Ao.has(n) || Ao.set(n, {});
  const r = Ao.get(n),
    i = JSON.stringify(t);
  return r[i] || (r[i] = new IntersectionObserver(e0, { root: e, ...t })), r[i];
}
function n0(e, t, n) {
  const r = t0(t);
  return (
...
function s0({ viewport: e = {} }, { viewport: t = {} } = {}) {
  return (n) => e[n] !== t[n];
}
const o0 = {
  inView: { Feature: i0 },
...
const Mc = {
  ...
  jp = {};
for (const e in Mc)
  jp[e] = () => (Vo[e] === void 0 && (Vo[e] = Mc[e]()), Vo[e]);
function p0(e, { repeat: t, repeatType: n = "loop" }) {
...
function v0(e, t, n, r, i) {
  let s,
    o,
    l = 0;
  do (o = t + (n - t) / 2), (s = Np(o, r, i) - e), s > 0 ? (n = o) : (t = o);
  while (Math.abs(s) > m0 && ++l < g0);
  return o;
}
function hi(e, t, n, r) {
...
const y0 = hi(0.42, 0, 1, 1),
  ...
  E0 = (e) => Xt(0, 255, e),
  Mo = { ...Pn, transform: (e) => Math.round(E0(e)) },
  cn = {
    test: ou("rgb", "red"),
...
const Fl = { test: ou("#"), parse: T0, transform: cn.transform },
  zn = {
    test: ou("hsl", "hue"),
  ...
  ye = {
    ...
    parse: (e) =>
      cn.test(e) ? cn.parse(e) : zn.test(e) ? zn.parse(e) : Fl.parse(e),
    transform: (e) =>
      fi(e) ? e : e.hasOwnProperty("red") ? cn.transform(e) : zn.transform(e),
  },
  K = (e, t, n) => -n * e + n * t + e;
function Do(e, t, n) {
  return (
...
const Rp = (e, t) => {
  const n = Oc(e),
    ...
    i = { ...n };
  return (s) => (
    (i.red = Oo(n.red, r.red, s)),
    (i.green = Oo(n.green, r.green, s)),
    (i.blue = Oo(n.blue, r.blue, s)),
...
function L0(e) {
  ...
  return (
    ...
    (((t = e.match(Js)) === null || t === void 0 ? void 0 : t.length) || 0) +
      (((n = e.match(lp)) === null || n === void 0 ? void 0 : n.length) || 0) >
      0
  );
}
const Ip = { regex: xy, countKey: "Vars", token: "${v}", parse: se },
  Fp = { regex: lp, countKey: "Colors", token: "${c}", parse: ye.parse },
  zp = { regex: Js, countKey: "Numbers", token: "${n}", parse: Pn.parse };
function Ro(e, { regex: t, countKey: n, token: r, parse: i }) {
...
function Up(e) {
  ...
  return (o) => {
    ...
    for (let a = 0; a < s; a++)
      a < r
        ? (l = l.replace(Ip.token, o[a]))
        : a < r + n
        ? (l = l.replace(Fp.token, ye.transform(o[a])))
        : (l = l.replace(zp.token, Mr(o[a])));
    return l;
  };
}
...
const Hp = (e, t) => {
  ...
  M0 = (e, t) => {
    const n = { ...e, ...t },
      r = {};
    for (const i in n)
      e[i] !== void 0 && t[i] !== void 0 && (r[i] = Wp(e[i], t[i]));
    return (i) => {
...
function Ts({
  ...
  const i = w0(r) ? r.map(Dc) : Dc(r),
    ...
    l = Xp(o, t, { ease: Array.isArray(i) ? i : z0(t, i) });
  return {
...
function Gp({ keyframes: e, restDelta: t, restSpeed: n, ...r }) {
  ...
  if (v < 1) {
    ...
    h = (w) => {
      ...
      return (
        s - S * (((g + v * E * x) / m) * Math.sin(m * w) + x * Math.cos(m * w))
      );
    };
    ...
    h = (w) => {
      const S = Math.exp(-v * E * w),
        T = Math.min(m * w, 300);
      return (
        s - (S * ((g + v * E * x) * Math.sinh(T) + m * x * Math.cosh(T))) / m
      );
    };
  }
  return {
  ...
  return (
    k(0),
    {
      ...
      next: (P) => {
        let L = !1;
        return (
          !T && S === void 0 && ((L = !0), w(P), k(P)),
          S !== void 0 && P > S ? T.next(P - S) : (!L && w(P), d)
        );
      },
    }
  );
...
const Z0 = { decay: zc, inertia: zc, tween: Ts, keyframes: Ts, spring: Gp };
function _s({
  autoplay: e = !0,
  delay: t = 0,
  driver: n = b0,
  ...
  const ee = (M) => {
      if (L === null) return;
      g > 0 && (L = Math.min(L, M)),
        g < 0 && (L = Math.min(M - he / g, L)),
        P !== null ? (Y = P) : (Y = Math.round(M - L) * g);
      const $ = Y - t * (g >= 0 ? 1 : -1),
        Jt = g >= 0 ? $ < 0 : $ > he;
      ...
      const Ne = Jt ? { done: !1, value: r[0] } : Cn.next(tt);
...
function t1(e, t, { onUpdate: n, onComplete: r, ...i }) {
  if (
    !(
      jp.waapi() &&
      J0.has(t) &&
  ...
  const v = h0(e.owner.current, t, c, { ...i, duration: f, ease: d, times: g }),
    x = () => v.cancel(),
    E = () => {
      G.update(x), l(), u();
    };
...
function n1({ keyframes: e, delay: t, onUpdate: n, onComplete: r }) {
  const i = () => (
    n && n(e[e.length - 1]),
    r && r(),
    {
  ...
  return t
    ? _s({ keyframes: [0, 1], duration: 0, delay: t, onComplete: i })
    : i();
}
const r1 = { type: "spring", stiffness: 500, damping: 25, restSpeed: 10 },
  i1 = (e) => ({
    type: "spring",
    stiffness: 550,
  ...
  o1 = { type: "keyframes", ease: [0.25, 0.1, 0.35, 1], duration: 0.3 },
  l1 = (e, { keyframes: t }) =>
    t.length > 2
      ? s1
      : Sn.has(e)
...
function bp(e, t) {
  let n = lu(e);
  return (
    n !== Ul && (n = Qt), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0
  );
}
...
class v1 {
  ...
  getVelocity() {
    return this.canTrackVelocity
      ? Qp(parseFloat(this.current) - parseFloat(this.prev), this.timeDelta)
      : 0;
  }
  start(t) {
    return (
      ...
      c === null &&
        (c =
          (i = (r = n[a]) !== null && r !== void 0 ? r : e.readValue(a)) !==
            ...
            : t[a]),
      c != null &&
        (typeof c == "string" && (m1(c) || Zp(c))
          ? (c = parseFloat(c))
          : !w1(c) && Qt.test(u) && (c = bp(a, u)),
        e.addValue(a, nr(c, { owner: e })),
        n[a] === void 0 && (n[a] = c),
...
function T1({ protectedKeys: e, needsAnimating: t }, n) {
...
function tm(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (const f in l) {
    ...
    d.start(au(f, d, g, e.shouldReduceMotion && Sn.has(f) ? { type: !1 } : v));
    const x = d.animation;
...
function V1(e) {
  return (t) =>
    Promise.all(t.map(({ animation: n, options: r }) => N1(e, n, r)));
}
function M1(e) {
  let t = V1(e);
  const n = O1();
    ...
    for (let p = 0; p < A1; p++) {
      ...
      (m.prevProp = w),
        ...
        L &&
          !k &&
          d.push(
            ...A.map((ee) => ({ animation: ee, options: { type: h, ...a } }))
          );
    }
    if (g.size) {
      const p = {};
...
const z1 = { animation: { Feature: R1 }, exit: { Feature: F1 } },
  $c = (e, t) => Math.abs(e - t);
function B1(e, t) {
  const n = $c(e.x, t.x),
    r = $c(e.y, t.y);
    ...
    if (
      ...
      (this.handlePointerMove = (u, c) => {
        (this.lastMoveEvent = u),
          (this.lastMoveEventInfo = Fo(c, this.transformPagePoint)),
...
function Dr(e, t, n, r) {
  Hc(e.x, t.x, n.x, r ? r.originX : void 0),
    Hc(e.y, t.y, n.y, r ? r.originY : void 0);
}
function Yc(e, t, n) {
...
function J1(e, t, n, r = !1) {
  ...
  for (let l = 0; l < i; l++) {
    ...
    (a && a.style && a.style.display === "contents") ||
      ...
      o && ((t.x *= o.x.scale), (t.y *= o.y.scale), om(e, o)),
      r && sn(s.latestValues) && Un(e, s.latestValues));
  }
...
class rx {
  ...
  start(t, { snapToCursor: n = !1 } = {}) {
    ...
    this.panSession = new nm(
      t,
      { onSessionStart: i, onStart: s, onMove: o, onSessionEnd: l },
  ...
  updateAxis(t, n, r) {
    ...
    this.constraints &&
      this.constraints[t] &&
      (o = H1(o, this.constraints[t], this.elastic[t])),
      s.set(o);
  }
  resolveConstraints() {
      ...
      i !== this.constraints &&
        ...
        it((s) => {
          this.getAxisMotionValue(s) &&
            (this.constraints[s] = K1(r.layoutBox[s], this.constraints[s]));
        });
  }
  ...
  scalePositionWithinConstraints() {
    ...
    it((o) => {
      ...
      if (l) {
        const a = l.get();
        i[o] = Q1({ min: a, max: a }, this.constraints[o]);
      }
    });
...
const gx = ["x", "scaleX", "originX"],
  vx = ["y", "scaleY", "originY"];
function df(e, t, n, r) {
  ff(e.x, t, gx, n ? n.x : void 0, r ? r.x : void 0),
    ff(e.y, t, vx, n ? n.y : void 0, r ? r.y : void 0);
}
function hf(e) {
...
function dm({
  ...
  return class {
    ...
    addEventListener(o, l) {
      return (
        this.eventHandlers.has(o) || this.eventHandlers.set(o, new fu()),
        ...
        e(o, () => {
          (this.root.updateBlockedByResize = !0),
            ...
            bi.hasAnimatedSinceResize &&
              ((bi.hasAnimatedSinceResize = !1), this.nodes.forEach(xf));
        });
      }
        ...
        this.options.animate !== !1 &&
          ...
          this.addEventListener(
            ...
            ({
              ...
              const x =
                  this.options.transition || c.getDefaultTransition() || zx,
              ...
              if (
                ...
                const w = { ...Jp(x, "layout"), onPlay: E, onComplete: p };
    ...
    update() {
      ...
      (X.delta = Xt(0, 1e3 / 60, l - X.timestamp)),
        (X.timestamp = l),
        (X.isProcessing = !0),
        Kn.update.process(X),
        Kn.preRender.process(X),
        Kn.render.process(X),
        (X.isProcessing = !1);
    }
    didUpdate() {
          ...
          if (
            ...
            this.relativeParent.target
              ...
              ? (this.resumingFrom
                ...
                om(this.target, this.targetDelta))
              : ze(this.target, this.layout.layoutBox),
            this.attemptToResolveRelativeTarget)
          ) {
    ...
    calcProjection() {
      ...
      if (
        ...
        a &&
          ...
          (u = !1),
        this.resolvedRelativeTargetAt === X.timestamp && (u = !1),
        u)
      )
        return;
      ...
      const d = this.treeScale.x,
        g = this.treeScale.y;
      J1(this.layoutCorrected, this.treeScale, this.path, a),
        l.layout &&
          !l.target &&
      ...
      (this.mixTargetDelta = (w) => {
        ...
        wf(f.x, o.x, S),
          ...
          this.relativeTarget &&
            ...
            (Or(d, this.layout.layoutBox, this.relativeParent.layout.layoutBox),
            Ix(this.relativeTarget, this.relativeTargetOrigin, d, S),
            m && Ql(this.relativeTarget, m) && (this.isProjectionDirty = !1),
            m || (m = ne()),
            ze(m, this.relativeTarget)),
          x &&
            ((this.animationValues = c), dx(c, u, this.latestValues, S, h, p)),
          this.root.scheduleUpdateProjection(),
          this.scheduleRender(),
    ...
    registerSharedNode(o, l) {
      this.sharedNodes.has(o) || this.sharedNodes.set(o, new yx()),
    ...
    getProjectionStyles(o = {}) {
      ...
      if (this.needsReset)
        return (
          (this.needsReset = !1),
          (u.opacity = ""),
          (u.pointerEvents = Gi(o.pointerEvents) || ""),
          ...
          this.options.layoutId &&
            ((x.opacity =
              this.latestValues.opacity !== void 0
                ...
                : 1),
            (x.pointerEvents = Gi(o.pointerEvents) || "")),
          this.hasProjected &&
      ...
      for (const x in Ps) {
        ...
        const { correct: E, applyTo: p } = Ps[x],
      ...
      return (
        this.options.layoutId &&
          (u.pointerEvents = f === this ? Gi(o.pointerEvents) || "" : "none"),
        u
      );
    }
    clearSnapshot() {
...
const zx = { duration: 0.45, ease: [0.4, 0, 0.1, 1] };
function Pf(e) {
...
function hm(e, t, n) {
  return (
    e === "position" || (e === "preserve-aspect" && !Wl(pf(t), pf(n), 0.2))
  );
}
const Ux = dm({
  ...
  $x = {
    pan: { Feature: ox },
    drag: { Feature: sx, ProjectionNode: pm, MeasureLayout: am },
  },
      ...
      (i.forEach((a) => {
        ...
        if (ks(d)) {
          const v = d.length,
            x = d[0] === null ? 1 : 0;
          (c = d[x]), (f = mr(c));
          for (let E = x; E < v && d[E] !== null; E++)
            g ? ru(mr(d[E]) === g) : (g = mr(d[E]));
        } else g = mr(d);
        if (f !== g)
          if (Cf(f) && Cf(g)) {
            const v = u.get();
...
function qx(e, t, n, r) {
  return Qx(t) ? Jx(e, t, n, r) : { target: t, transitionEnd: r };
}
const ew = (e, t, n, r) => {
    const i = Yx(e, t, r);
...
function nw(e, t, n) {
  ...
  for (const i in t) {
    ...
    else if (je(o)) e.addValue(i, nr(s, { owner: e })), js(r) && r.remove(i);
    else if (o !== s)
      if (e.hasValue(i)) {
        ...
        e.addValue(i, nr(l !== void 0 ? l : s, { owner: e }));
      }
  }
...
class sw {
  ...
  getValue(t, n) {
    ...
    return (
      r === void 0 &&
        n !== void 0 &&
        ((r = nr(n, { owner: this })), this.addValue(t, r)),
      r
    );
  }
  readValue(t) {
...
const uw = (e, t) =>
    Ga(e)
      ? new aw(t, { enableHardwareAcceleration: !1 })
      : new lw(t, { enableHardwareAcceleration: !0 }),
  cw = { layout: { ProjectionNode: pm, MeasureLayout: am } },
  fw = { ...z1, ...o0, ...$x, ...cw },
...
function vw(e, t, n, r, i) {
  var s,
    o,
    l = 0;
  do (o = t + (n - t) / 2), (s = Ls(o, r, i) - e), s > 0 ? (n = o) : (t = o);
  while (Math.abs(s) > pw && ++l < mw);
  return o;
}
function yw(e, t, n, r) {
  for (var i = 0; i < dw; ++i) {
...
var ww = function (t, n, r, i) {
  ...
  for (var s = gw ? new Float32Array(Pr) : new Array(Pr), o = 0; o < Pr; ++o)
    s[o] = Ls(o * Oi, t, r);
  function l(a) {
  ...
  return (
    kw.forEach(function (r) {
      ...
      if (typeof (e == null ? void 0 : e[r]) == "number") {
        ...
        t === qe.vertical && (n.translateY = c),
          t === qe.horizontal && (n.translateX = c);
      }
      if (Array.isArray(e == null ? void 0 : e[r])) {
        ...
        if (typeof f[0] < "u" && typeof f[1] < "u") {
          ...
          if (
            ((n[r] = { start: d.value, end: g.value, unit: d.unit, easing: v }),
            d.unit !== g.unit)
          )
            throw new Error(
...
function Mw(e, t, n, r) {
  ...
  var a = new du({ startX: s, startY: i, endX: l, endY: o });
  return a;
}
function En(e, t, n) {
  var r = t > e,
...
function Dw(e, t, n, r, i, s) {
  ...
  var w = 1,
    S = 1;
  if (
    (i === qe.horizontal && ((w = En(u, c, t.width + e.width)), (S = w)),
    d < 0 && (v = v + d * h),
    g > 0 && (E = E + g * m),
    u < 0 && (x = x + u * w),
    c > 0 && (p = p + c * S),
    ...
    if (
      (T && P && ((h = 1), (m = 1), (v = 0), (E = t.scrollHeight - t.height)),
      k && L && ((w = 1), (S = 1), (x = 0), (p = t.scrollWidth - t.width)),
      !T && P)
    ) {
...
function Rw(e, t, n) {
  return e.rootMargin || e.targetElement || e.shouldDisableScalingTranslations
    ? !1
    : !!(
        (t.translateX && n === qe.horizontal) ||
        (t.translateY && n === qe.vertical)
      );
}
  ...
  Iw = (function () {
    function e(n) {
      (this.el = n.el),
        ...
        (this.id = Sw()),
        (this.effects = Vf(this.props, this.scrollAxis)),
        (this.isInView = null),
        (this.progress = 0),
        this._setElementEasing(n.props.easing),
        Nw(n.el, this.effects);
    }
    var t = e.prototype;
    return (
      (t.updateProps = function (r) {
        return (
          (this.props = $t({}, this.props, r)),
          (this.effects = Vf(r, this.scrollAxis)),
        ...
        return typeof this.props.startScroll == "number" &&
          ...
          : (s
              ? ((this.limits = Dw(
                ...
                (this.scaledEffects = Ow(this.effects, this.limits)))
              : (this.limits = Mw(
                  this.rect,
                  r,
                  i,
      ...
      (t.updatePosition = function (r) {
        ...
        if ((this._updateElementIsInView(c), c)) {
          ...
          s &&
            ((this.progress = Rf(Math.round(Mf(o, a, u, this.easing)), 0, 1)),
            this._setElementStyles());
        return this;
      }),
      e
    ...
    (t._updateAllElements = function (r) {
      ...
      this.elements &&
        this.elements.forEach(function (l) {
          o && l.setCachedAttributes(i.view, i.scroll),
...
function q(e) {
  var t = Tm(e),
    ...
    i = Xw(n),
    s = i.ref;
  return Ve.createElement("div", Object.assign({ ref: s }, r), e.children);
}
var Qw = function (t) {
  ...
  jm = (function (e) {
    ...
    return (
      (n.componentDidUpdate = function (i) {
        if (
          i.scrollContainer !== this.props.scrollContainer &&
          this.props.scrollContainer
        ) {
          var s;
          (s = this.controller) == null ||
            s.updateScrollContainer(this.props.scrollContainer);
        }
      ...
      (n.render = function () {
        ...
        return Ve.createElement(_m.Provider, { value: this.controller }, i);
      }),
      t
    );
  })(N.Component);
jm.defaultProps = { scrollAxis: qe.vertical };
const Kw = () =>
    y.jsx(y.Fragment, {
      children: y.jsxs("div", {
        className:
          "bg-lblu min-h-screen w-full flex items-center justify-center relative",
        id: "hero",
        children: [
          y.jsxs(q, {
            translateY: [40, -70],
            className:
              "max-w-screen-xl h-full p-8 pt-32 md:pt-8 mx-auto flex flex-col items-center justify-center gap-y-8 z-40",
            children: [
              y.jsx("p", {
                className:
                  "font-caprasimo text-yllw text-8xl lg:text-9xl text-center hero-stroke",
                children: "GREAT AUK",
              }),
              y.jsx("p", {
                className:
                  "text-drkblu text-xl md:text-2xl text-center font-bold max-w-lg",
                children:
                  "Nature always adorns itself with the colors of the soul!",
              }),
              y.jsxs("div", {
          ...
          y.jsx(q, {
            translateY: [20, -30],
            className:
              "background-main w-full h-auto absolute bottom-0 lg:-bottom-[30%] left-0 right-0 z-30",
            children: y.jsx(Rr.img, {
              initial: { y: 0 },
              animate: { y: [1, 15, 1] },
              transition: { duration: 3, repeat: 1 / 0 },
              src: "./assets/Don’t shoot me (1).png",
              alt: "trees-svg",
              className: "w-full",
            }),
          }),
  ...
  Gw = () =>
    y.jsxs(y.Fragment, {
      children: [
        y.jsxs("div", {
          className:
            "bg-lblu w-full flex flex-col items-center justify-center relative",
          id: "history",
          children: [
            y.jsx(q, {
              translateX: [-15, 0],
              ...
              children: y.jsx(Rr.img, {
                ...
                animate: { scale: [1, 1.04, 1], rotateX: [0, 15, 0] },
                transition: { duration: 5, repeat: 1 / 0 },
                src: "./assets/Logo.png",
                alt: "",
                className: "h-64 lg:h-auto img-logo",
              }),
            }),
            y.jsx(Rr.img, {
              initial: { y: 0 },
            ...
            y.jsxs("div", {
              className:
                "max-w-screen-xl h-full p-8 lg:pt-80 pb-80 lg:pb-32 mx-auto flex flex-col items-center justify-center gap-y-8 z-20",
              children: [
                y.jsxs("div", {
                  className:
                  ...
                  children: [
                    y.jsx("p", {
                      className:
                        "font-caprasimo text-white text-5xl lg:text-7xl leading-[2.5rem] hero-stroke",
                      children: "HISTORY OF",
                    }),
                    y.jsx("p", {
                      className:
                        "font-caprasimo text-yllw text-8xl lg:text-9xl text-center leading-[6rem] hero-stroke",
                      children: "GREAT AUK BIRDS",
                    }),
                  ],
                }),
                y.jsx("div", {
                  className:
                    "p-4 lg:p-12 bg-llbrwn border-solid border-[7px] border-ddbrwn",
                  children: y.jsx("div", {
        ...
        y.jsx("div", { className: "bg-grn w-full h-20" }),
      ],
    }),
  bw = () =>
    y.jsx(y.Fragment, {
      children: y.jsxs("div", {
        className:
          "bg-lbrwn w-full flex flex-col items-center justify-center relative",
        children: [
          y.jsx("img", {
          ...
          y.jsx("div", {
            className:
              "max-w-screen-xl h-full p-8 mx-auto flex flex-col items-center justify-center gap-y-8 z-20",
            children: y.jsxs("div", {
              className:
                "font-caprasimo text-white token-stroke flex flex-col lg:flex-row gap-y-8 relative w-full h-full",
              children: [
                y.jsx(q, {
                  translateX: [-25, 35],
                  className: "w-full",
                  children: y.jsx("p", {
                    ...
                    children: "The great auk bird's pranks were so legendary",
                  }),
                }),
                y.jsxs("div", {
  ...
  Zw = () =>
    y.jsx(y.Fragment, {
      children: y.jsxs("div", {
        className:
          "bg-dbrwn w-full flex flex-col items-center justify-center relative",
        id: "roadmap",
        children: [
          y.jsx("img", {
          ...
          y.jsxs("div", {
            className:
              "max-w-screen-xl h-full p-8 py-32 mx-auto flex flex-col items-center justify-center gap-y-8 z-20",
            children: [
              y.jsx("div", {
                className: "flex flex-col items-center justify-center gap-y-8",
                children: y.jsx("p", {
                  className:
                    "font-caprasimo text-yllw text-4xl md:text-8xl lg:text-9xl text-center leading-[1rem] md:leading-[4rem] lg:leading-[6rem] token-stroke",
                  children: "ROADMAP",
                }),
              }),
              y.jsxs("div", {
                className:
                  "flex flex-col w-full h-auto items-center justify-center relative",
                children: [
                  y.jsxs(q, {
                    translateX: [35, 15],
                    className:
                      "w-full h-auto flex flex-row-reverse items-center justify-center relative justify-self-end",
                    children: [
                      y.jsxs("div", {
                        className:
                          "w-full text-ddbrwn flex flex-col items-center justify-center absolute gap-y-4",
                        children: [
                          y.jsx("p", {
                  ...
                  y.jsxs(q, {
                    translateX: [-35, 15],
                    className:
                      "w-full flex items-center justify-center relative justify-self-start",
                    children: [
                      y.jsxs("div", {
                        className:
                          "w-full text-ddbrwn flex flex-col items-center justify-center absolute gap-y-4",
...
function Lm(e) {
  return (
    e &&
    e.map(function (t, n) {
      return Ve.createElement(t.tag, Wt({ key: n }, t.attr), Lm(t.child));
    })
  );
}
function qw(e) {
  return function (t) {
    return Ve.createElement(eS, Wt({ attr: Wt({}, e.attr) }, t), Lm(e.child));
  };
}
function eS(e) {
  var t = function (n) {
    ...
    return (
      ...
      Ve.createElement(
        ...
        s && Ve.createElement("title", null, s),
        e.children
      )
    );
  };
  return Ff !== void 0
    ? Ve.createElement(Ff.Consumer, null, function (n) {
        return t(n);
      })
    : t(Nm);
}
...
const nS = () =>
    y.jsx(y.Fragment, {
      children: y.jsxs("div", {
        className:
          "bg-brwn w-full flex flex-col items-center justify-center relative",
        id: "tokenomics",
        children: [
          y.jsx("img", {
            src: "/token-trans.svg",
          ...
          y.jsxs("div", {
            className:
              "max-w-screen-xl h-full p-8 pt-32 mx-auto flex flex-col items-center justify-center gap-y-8 z-20",
            children: [
              y.jsx("div", {
                className: "flex flex-col items-center justify-center gap-y-8",
                children: y.jsx("p", {
              ...
              y.jsxs("div", {
                className:
                  "flex flex-col lg:flex-row gap-y-4 justify-between w-full",
                children: [
                  y.jsxs(q, {
                    translateX: [-25, 0],
                    className: "text-center font-caprasimo token-stroke",
              ...
              y.jsxs("div", {
                className:
                  "flex gap-x-2 items-center justify-center py-4 text-ddbrwn",
                children: [
                  y.jsx(tS, {
                    onClick:()=>{
                ...
                children: [
                  y.jsxs("a", {
                    ...
                    children: [
                      ...
                      y.jsxs("div", {
                        className:
                          "relative flex items-center justify-center cursor-pointer hover:scale-[1.08] transition-all ease-in-out duration-300 w-60 lg:w-auto",
                        children: [
                          y.jsx("img", {
                          ...
                          y.jsx("p", {
                            className:
                              "text-2xl lg:text-4xl text-center font-caprasimo absolute",
                            children: "CHARTS ",
                          }),
                        ],
                      }),
  ...
  rS = () =>
    y.jsx(y.Fragment, {
      children: y.jsxs("div", {
        className:
          "bg-dbrwn w-full flex flex-col items-center justify-center relative overflow-y-hidden",
        id: "fossil",
        children: [
          y.jsx("div", {
            className:
            ...
            children: y.jsx(q, {
              ...
              scale: [0.9, 1],
              className: "w-full",
              children: y.jsx("img", { src: "/fossil.svg", alt: "" }),
            }),
          }),
          y.jsx("img", {
  ...
  iS = () =>
    y.jsx("footer", {
      ...
      children: y.jsxs("div", {
        className:
          "max-w-screen-xl h-full p-8 mx-auto flex items-center justify-between font-bold text-lbrwn text-lg",
        children: [
          y.jsx("p", { className: "", children: "Great Auk" }),
          y.jsx("a", {
            href: "#hero",
            children: y.jsx("p", {
...
function sS() {
  return y.jsxs(y.Fragment, {
    children: [
      y.jsx("div", { className: "fixed w-full z-50", children: y.jsx(iy, {}) }),
      y.jsxs("div", {
...
$o.createRoot(document.getElementById("root")).render(
  y.jsx(Ve.StrictMode, { children: y.jsx(jm, { children: y.jsx(sS, {}) }) })
);
